#############################################################################
# Makefile for building: Icosahedron
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  Icosahedron.pro
# Template: app
# Command: /Users/chanteywu/Qt/5.5/clang_64/bin/qmake -spec macx-clang CONFIG+=x86_64 -o Makefile Icosahedron.pro
#############################################################################
...
CXXFLAGS      = -pipe -O2 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk -std=c++11 -stdlib=libc++ -mmacosx-version-min=10.7 -Wall -W -fPIC $(DEFINES)
INCPATH       = -I. -I../../Qt/5.5/clang_64/mkspecs/macx-clang
QMAKE         = /Users/chanteywu/Qt/5.5/clang_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Icosahedron1.0.0
DISTDIR = /Users/chanteywu/Desktop/Icosahedron/.tmp/Icosahedron1.0.0
...
LIBS          = $(SUBLIBS) -framework GLUT -framework OpenGL -framework Cocoa 
...
SOURCES       = icosahedron.cc 
OBJECTS       = icosahedron.o
DIST          = ../../Qt/5.5/clang_64/mkspecs/features/spec_pre.prf \
		...
		Icosahedron.pro  icosahedron.cc
QMAKE_TARGET  = Icosahedron
...
Makefile: Icosahedron.pro ../../Qt/5.5/clang_64/mkspecs/macx-clang/qmake.conf ../../Qt/5.5/clang_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.5/clang_64/mkspecs/qdevice.pri \
		../../Qt/5.5/clang_64/mkspecs/features/device_config.prf \
		../../Qt/5.5/clang_64/mkspecs/common/unix.conf \
		../../Qt/5.5/clang_64/mkspecs/common/mac.conf \
		...
		../../Qt/5.5/clang_64/mkspecs/features/lex.prf \
		Icosahedron.pro
	$(QMAKE) -spec macx-clang CONFIG+=x86_64 -o Makefile Icosahedron.pro
...
icosahedron.o: icosahedron.cc 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o icosahedron.o icosahedron.cc
